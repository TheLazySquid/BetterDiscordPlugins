...
var import_gifuct_js2 = __toESM(require_lib2(), 1);
...
// plugins/GifCaptioner/src/render.ts
var import_gif = __toESM(require_gif2(), 1);
...
watchElement(gifSelector, (gif) => {
  ...
  captionBtn.addEventListener("click", async (e) => {
    ...
    if (isVideo) width = gif.videoWidth;
      ...
      parsedGif = (0, import_gifuct_js2.parseGIF)(buff);
      width = parsedGif.lsd.width;
    }

...
const imgAdder: any = Object.values(BdApi.Webpack.getModule(module => Object.values<any>(module)?.[0]?.addFile) as any)[0];
const chatKeyHandlers: any = BdApi.Webpack.getModule((exports) => Object.values<any>(exports)?.[0]?.
